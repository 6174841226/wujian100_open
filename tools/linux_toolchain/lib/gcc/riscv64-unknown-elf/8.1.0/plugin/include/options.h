...
#endif
#ifdef GENERATOR_FILE
extern int riscv_xcki_fldr;
#else
  int x_riscv_xcki_fldr;
#define riscv_xcki_fldr global_options.x_riscv_xcki_fldr
#endif
#ifdef GENERATOR_FILE
extern int riscv_xcki_ldd;
#else
  int x_riscv_xcki_ldd;
#define riscv_xcki_ldd global_options.x_riscv_xcki_ldd
#endif
#ifdef GENERATOR_FILE
extern int riscv_xcki_ldd_more;
#else
  int x_riscv_xcki_ldd_more;
#define riscv_xcki_ldd_more global_options.x_riscv_xcki_ldd_more
#endif
#ifdef GENERATOR_FILE
extern int riscv_xcki_ldi;
#else
  int x_riscv_xcki_ldi;
#define riscv_xcki_ldi global_options.x_riscv_xcki_ldi
#endif
#ifdef GENERATOR_FILE
extern int riscv_xcki_ldr;
#else
  int x_riscv_xcki_ldr;
#define riscv_xcki_ldr global_options.x_riscv_xcki_ldr
#endif
#ifdef GENERATOR_FILE
extern int riscv_xcki_opt_lbu;
#else
  int x_riscv_xcki_opt_lbu;
#define riscv_xcki_opt_lbu global_options.x_riscv_xcki_opt_lbu
#endif
#ifdef GENERATOR_FILE
...
#define TARGET_XCKI ((target_flags & MASK_XCKI) != 0)
...
enum opt_code
{
  ...
  OPT_mabi_ = 1190,                          /* -mabi= */
  OPT_maddsl = 1191,                         /* -maddsl */
  OPT_maddsluw = 1192,                       /* -maddsluw */
  OPT_march_ = 1193,                         /* -march= */
  OPT_mbit_translate = 1194,                 /* -mbit-translate */
  OPT_mbranch_cost_ = 1195,                  /* -mbranch-cost= */
  OPT_mcbranch32 = 1196,                     /* -mcbranch32 */
  OPT_mcmodel_ = 1197,                       /* -mcmodel= */
  OPT_mcondmv = 1198,                        /* -mcondmv */
  OPT_mdiv = 1199,                           /* -mdiv */
  OPT_mdse_losum = 1200,                     /* -mdse-losum */
  OPT_mexpand_split_imm = 1201,              /* -mexpand-split-imm */
  OPT_mexplicit_relocs = 1202,               /* -mexplicit-relocs */
  OPT_mext = 1203,                           /* -mext */
  OPT_mfdiv = 1204,                          /* -mfdiv */
  OPT_minterrupt_consecutive_branch = 1205,  /* -minterrupt-consecutive-branch */
  OPT_minterrupt_consecutive_branch2 = 1206, /* -minterrupt-consecutive-branch2 */
  OPT_miv_adjust_addr_cost = 1207,           /* -miv-adjust-addr-cost */
  OPT_mmula = 1208,                          /* -mmula */
  OPT_mplt = 1209,                           /* -mplt */
  OPT_mpreferred_stack_boundary_ = 1210,     /* -mpreferred-stack-boundary= */
  OPT_mrelax = 1211,                         /* -mrelax */
  OPT_mrev = 1212,                           /* -mrev */
  OPT_mrevw = 1213,                          /* -mrevw */
  OPT_msave_restore = 1214,                  /* -msave-restore */
  OPT_msignedness_cmpiv = 1215,              /* -msignedness-cmpiv */
  OPT_msmall_data_limit_ = 1216,             /* -msmall-data-limit= */
  OPT_msrri = 1217,                          /* -msrri */
  OPT_msrriw = 1218,                         /* -msrriw */
  OPT_mstrict_align = 1219,                  /* -mstrict-align */
  OPT_mstrip_sextw = 1220,                   /* -mstrip-sextw */
  OPT_mthread_jumps1 = 1221,                 /* -mthread-jumps1 */
  OPT_mtst = 1222,                           /* -mtst */
  OPT_mtune_ = 1223,                         /* -mtune= */
  OPT_mxcki_fldr = 1224,                     /* -mxcki-fldr */
  OPT_mxcki_ldd = 1225,                      /* -mxcki-ldd */
  OPT_mxcki_ldd_more = 1226,                 /* -mxcki-ldd-more */
  OPT_mxcki_ldi = 1227,                      /* -mxcki-ldi */
  OPT_mxcki_ldr = 1228,                      /* -mxcki-ldr */
  OPT_mxcki_opt_lbu = 1229,                  /* -mxcki-opt-lbu */
  OPT_mxor_combine = 1230,                   /* -mxor-combine */
  OPT_n = 1231,                              /* -n */
  OPT_no_canonical_prefixes = 1232,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1233,              /* -no-integrated-cpp */
  OPT_no_pie = 1234,                         /* -no-pie */
  OPT_nocpp = 1235,                          /* -nocpp */
  OPT_nodefaultlibs = 1236,                  /* -nodefaultlibs */
  OPT_nostartfiles = 1237,                   /* -nostartfiles */
  OPT_nostdinc = 1238,                       /* -nostdinc */
  OPT_nostdinc__ = 1239,                     /* -nostdinc++ */
  OPT_nostdlib = 1240,                       /* -nostdlib */
  OPT_o = 1241,                              /* -o */
  OPT_p = 1242,                              /* -p */
  OPT_pass_exit_codes = 1243,                /* -pass-exit-codes */
  /* OPT_pedantic = 1244, */                 /* -pedantic */
  OPT_pedantic_errors = 1245,                /* -pedantic-errors */
  OPT_pg = 1246,                             /* -pg */
  OPT_pie = 1247,                            /* -pie */
  OPT_pipe = 1248,                           /* -pipe */
  OPT_print_file_name_ = 1249,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1250,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1251,          /* -print-multi-directory */
  OPT_print_multi_lib = 1252,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1253,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1254,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1255,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1256,               /* -print-prog-name= */
  OPT_print_search_dirs = 1257,              /* -print-search-dirs */
  OPT_print_sysroot = 1258,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1259,   /* -print-sysroot-headers-suffix */
  OPT_quiet = 1260,                          /* -quiet */
  OPT_r = 1261,                              /* -r */
  OPT_remap = 1262,                          /* -remap */
  OPT_s = 1263,                              /* -s */
  OPT_save_temps = 1264,                     /* -save-temps */
  OPT_save_temps_ = 1265,                    /* -save-temps= */
  OPT_shared = 1266,                         /* -shared */
  OPT_shared_libgcc = 1267,                  /* -shared-libgcc */
  /* OPT_specs = 1268, */                    /* -specs */
  OPT_specs_ = 1269,                         /* -specs= */
  OPT_static = 1270,                         /* -static */
  OPT_static_libasan = 1271,                 /* -static-libasan */
  OPT_static_libgcc = 1272,                  /* -static-libgcc */
  OPT_static_libgfortran = 1273,             /* -static-libgfortran */
  OPT_static_libgo = 1274,                   /* -static-libgo */
  OPT_static_liblsan = 1275,                 /* -static-liblsan */
  OPT_static_libmpx = 1276,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 1277,          /* -static-libmpxwrappers */
  OPT_static_libstdc__ = 1278,               /* -static-libstdc++ */
  OPT_static_libtsan = 1279,                 /* -static-libtsan */
  OPT_static_libubsan = 1280,                /* -static-libubsan */
  OPT_static_pie = 1281,                     /* -static-pie */
  /* OPT_std_c__03 = 1282, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1283, */                /* -std=c++0x */
  OPT_std_c__11 = 1284,                      /* -std=c++11 */
  OPT_std_c__14 = 1285,                      /* -std=c++14 */
  OPT_std_c__17 = 1286,                      /* -std=c++17 */
  /* OPT_std_c__1y = 1287, */                /* -std=c++1y */
  /* OPT_std_c__1z = 1288, */                /* -std=c++1z */
  OPT_std_c__2a = 1289,                      /* -std=c++2a */
  OPT_std_c__98 = 1290,                      /* -std=c++98 */
  OPT_std_c11 = 1291,                        /* -std=c11 */
  OPT_std_c17 = 1292,                        /* -std=c17 */
  /* OPT_std_c18 = 1293, */                  /* -std=c18 */
  /* OPT_std_c1x = 1294, */                  /* -std=c1x */
  /* OPT_std_c89 = 1295, */                  /* -std=c89 */
  OPT_std_c90 = 1296,                        /* -std=c90 */
  OPT_std_c99 = 1297,                        /* -std=c99 */
  /* OPT_std_c9x = 1298, */                  /* -std=c9x */
  OPT_std_f2003 = 1299,                      /* -std=f2003 */
  OPT_std_f2008 = 1300,                      /* -std=f2008 */
  OPT_std_f2008ts = 1301,                    /* -std=f2008ts */
  OPT_std_f2018 = 1302,                      /* -std=f2018 */
  OPT_std_f95 = 1303,                        /* -std=f95 */
  OPT_std_gnu = 1304,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1305, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1306, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1307,                    /* -std=gnu++11 */
  OPT_std_gnu__14 = 1308,                    /* -std=gnu++14 */
  OPT_std_gnu__17 = 1309,                    /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 1310, */              /* -std=gnu++1y */
  /* OPT_std_gnu__1z = 1311, */              /* -std=gnu++1z */
  OPT_std_gnu__2a = 1312,                    /* -std=gnu++2a */
  OPT_std_gnu__98 = 1313,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1314,                      /* -std=gnu11 */
  OPT_std_gnu17 = 1315,                      /* -std=gnu17 */
  /* OPT_std_gnu18 = 1316, */                /* -std=gnu18 */
  /* OPT_std_gnu1x = 1317, */                /* -std=gnu1x */
  /* OPT_std_gnu89 = 1318, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1319,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1320,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1321, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1322, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1323,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1324, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1325, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 1326, */         /* -std=iso9899:2011 */
  /* OPT_std_iso9899_2017 = 1327, */         /* -std=iso9899:2017 */
  /* OPT_std_iso9899_2018 = 1328, */         /* -std=iso9899:2018 */
  OPT_std_legacy = 1329,                     /* -std=legacy */
  OPT_symbolic = 1330,                       /* -symbolic */
  OPT_t = 1331,                              /* -t */
  OPT_time = 1332,                           /* -time */
  OPT_time_ = 1333,                          /* -time= */
  OPT_traditional = 1334,                    /* -traditional */
  OPT_traditional_cpp = 1335,                /* -traditional-cpp */
  OPT_trigraphs = 1336,                      /* -trigraphs */
  OPT_u = 1337,                              /* -u */
  OPT_undef = 1338,                          /* -undef */
  OPT_v = 1339,                              /* -v */
  OPT_version = 1340,                        /* -version */
  OPT_w = 1341,                              /* -w */
  OPT_wrapper = 1342,                        /* -wrapper */
  OPT_x = 1343,                              /* -x */
  OPT_z = 1344,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
